    ...
    if (obj.fechaCuota1) {
        ...
        switch (obj.formaPago) {
            case 'semanal':
                ...
                diferencia = (fechaCuota1.getTime() - obj.fechaDesembolso.getTime()) / (1000 * 60 * 60 * 24);
                if (diferencia <= 3 ) {
                    day += 7;
                    fechaCuota1 = new Date(year,month, day);
                }
            ...
            case 'mensual':
                ...
                diferencia = (fechaCuota1.getTime() - fechaDesembolso.getTime()) / (1000*60*60*24);

                if (diferencia <= 15) {
                    month ++;
                    if ( diapago1 === 31 && (month === 3 || month === 5 || month === 8 || month === 10)) {
                        day = 30;
