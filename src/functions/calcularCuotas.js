...
const calcularCuotas = obj => {
    if ( !obj.prestamo || !obj.plazo || !obj.unidadPlazo || !obj.formaPago || !obj.diapago1 || !obj.tasa || !obj.fechaDesembolso) {
        return (
            <p className='alerta'>
    ...
    let fechaUltimoDia = getFechaUltimaCuota( fechaPrimerDia, obj.unidadPlazo, obj.plazo);


    switch (obj.formaPago) {
        case 'semanal':
            let diasTotales = (fechaUltimoDia.getTime() - fechaPrimerDia.getTime()) / (1000 * 60 * 60 * 24);
