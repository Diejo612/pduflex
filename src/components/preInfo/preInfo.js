        ...
        return (
            <div className='pre-info'>
                <div className='cantidad-cuotas'>
                    ...
                    <input type='number' name='cantidad-cuotas' id='cantidad-cuotas' value={calcularCuotas(this.props.datosFormulario)} disabled readOnly/>
                </div>
                <div className='tasa-diaria'>
                    <label htmlFor="tasa-diaria">Tasa Diaria</label>
                    <input type="number" name="tasa-diaria" id="tasa-diaria" value={tasa.toFixed(5)} disabled readOnly/>    
                </div>
                
                <div className='importe de Cuota'>
                    <label htmlFor="valorCuotaIndividual">Importe por cuota</label>
                    <input type='number' name='valorCuotaIndividual' id='valor' readOnly />
                </div>
